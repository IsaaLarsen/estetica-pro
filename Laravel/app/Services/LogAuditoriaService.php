...
class LogAuditoriaService
{
     ...
     * @param  Model        $model        Instância do model (Agenda, Comissao, Cliente, etc.)
    ...
    public static function registrarModel(string $action, Model $model, ?array $dadosAntigos = null): void
    {
        ...
        // CORREÇÃO: Usar formato ISO8601 simples sem offset problemático
        $timestamp = Carbon::now('America/Sao_Paulo')->toISOString();
