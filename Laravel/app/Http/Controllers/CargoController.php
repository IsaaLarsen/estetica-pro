...
class CargoController extends Controller
{
    ...
    public function index()
    {
        ...
        // 🔹 Paginação oficial: 9 registros por página
        $cargos = Cargo::orderBy('nome')->paginate(9);
    ...
    public function store(Request $request)
    {
        ...
        // 🔐 LOG: registrar criação
        if ($cargo) {
            LogAuditoriaService::registrarModel('create', $cargo);
        }
    ...
    public function update(Request $request, Cargo $cargo)
    {
        ...
        // 🔐 LOG: registrar update com dados antigos
        LogAuditoriaService::registrarModel('update', $cargo, $dadosAntigos);
    ...
    public function destroy(Cargo $cargo)
    {
        ...
        LogAuditoriaService::registrarDeleteModel($cargo);
