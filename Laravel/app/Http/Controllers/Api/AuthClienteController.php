...
class AuthClienteController extends Controller
{
    ...
    public function register(Request $r)
    {
        ...
        $cliente = Cliente::create([
            'nome'            => $r->nome,
            'email'           => $r->email,
            'senha'           => $r->password, // cast 'hashed' no Model fará o hash
            'telefone'        => $r->telefone,
            'cpf'             => $r->cpf,
            'endereco'        => $r->endereco,
     ...
     *
     * Compatível com o Flutter:
     * res.data['nome'] / res.data['name']
     */
    public function me(Request $r)
    {
        $cliente = $r->user(); // cliente autenticado pelo token Sanctum
    ...
    public function forgotPassword(Request $r)
    {
        ...
        $cliente = Cliente::where('email', $r->email)
            ->where('cpf', $cpf)
