...
class SettingController extends Controller
{
    ...
    public function edit()
    {
        ...
        // Dias da semana padrão de funcionamento
        // 0=Dom, 1=Seg, 2=Ter, 3=Qua, 4=Qui, 5=Sex, 6=Sáb
        $diasString = Setting::get('expediente_dias_semana', '1,2,3,4,5'); // default: seg–sex
        $diasSemana = array_filter($diasString !== null ? explode(',', $diasString) : [], 'strlen');
        ...
        return view('settings.edit', compact('inicio', 'fim', 'excecoes', 'funcionarios', 'diasSemana'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $antigos = [
            ...
            'expediente_dias_semana' => Setting::get('expediente_dias_semana'),
        ];

        Setting::set('expediente_inicio', $inicio);
        Setting::set('expediente_fim',    $fim);
        Setting::set('expediente_dias_semana', $diasString);
        ...
        $this->registrarLogSettings(
            ...
            [
                ...
                'expediente_fim'         => $fim,
                'expediente_dias_semana' => $diasString,
            ],
            $antigos
        );
