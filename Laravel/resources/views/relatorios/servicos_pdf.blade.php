    ...
    <tbody>
        @forelse($servicosResumo as $s)
            <tr>
                ...
                <td class="text-right">{{ number_format($s->total_atendimentos ?? 0, 0, ',', '.') }}</td>
                <td class="text-right">{{ number_format($s->faturamento ?? 0, 2, ',', '.') }}</td>
                <td class="text-right">{{ number_format($s->ticket_medio ?? 0, 2, ',', '.') }}</td>
                <td class="text-right">{{ number_format($s->participacao ?? 0, 1, ',', '.') }}%</td>
            </tr>
        @empty
            <tr>
