...
@section('content')
    ...
    <style>
        ...
        td{ padding:16px; }
        tbody tr{ border-bottom:1px solid #f3f4f6; transition:background-color .2s; }
        /* 🔥 Hover sem "chegar mais perto" */
    ...
    <div class="content">
                                ...
                                <div class="service-details">
                                    ...
                                    <p>
                                        @if(!empty($s->descricao))
                                            {{ \Illuminate\Support\Str::limit($s->descricao, 30) }}
                                        @else
                                            —
                                        @endif
                                    </p>
        ...
        {{-- Paginação nova padrão Estética PRO --}}
        @if($servicos instanceof \Illuminate\Contracts\Pagination\Paginator && $servicos->hasPages())
            <div style="margin-top:16px; display:flex; justify-content:center;">
                @include('partials.pagination', ['paginator' => $servicos])
            </div>
        @endif
    </div>
