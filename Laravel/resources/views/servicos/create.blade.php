...
@section('content')
    <style>
        ...
        .func-item.selected {
            order: -1;
            /* Coloca os selecionados no topo */
        }
            ...
            <form method="POST" action="{{ $servico ? route('servicos.update', $servico->id) : route('servicos.store') }}">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="valor" name="valor" placeholder="Ex: 120,00"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="comissao_percent" name="comissao_percent" placeholder="Ex: 40,00"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duracao_minutos" min="5" max="1440" name="duracao_minutos"
                            value="{{ old('duracao_minutos', $servico->duracao_minutos ?? 30) }}" required>
                    </div>
                    ...
                    <div class="form-group full-width">
                        <div class="form-section">
                            ...
                            <div class="search-container">
                                ...
                                <input type="text" class="form-input search-input" id="searchFuncionarios"
                                    ...
                                    @if(in_array($f->id, $vinculadosIds))
                                        ...
                                        <li class="func-item selected" data-nome="{{ $nomeData }}">
                                            <label class="func-label checked" for="funcionario-{{ $f->id }}">
                                                <input type="checkbox" name="funcionarios[]" value="{{ $f->id }}"
                                                    id="funcionario-{{ $f->id }}" checked>
