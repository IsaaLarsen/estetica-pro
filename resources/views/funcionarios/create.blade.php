...
@section('content')
    ...
    <style>
        ...
        /* centralização do switch - CORRIGIDO */
        ...
        /* Switch ativo - ESTILO ORIGINAL BONITINHO */
        .form-switch {
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .switch {
            ...
            width: 50px;
            height: 24px;
            margin: 0 auto; /* CENTRALIZA O SWITCH */
        }
        ...
        <div class="form-container">
            ...
            <form method="POST"
                ...
                <div class="form-grid">
                    ...
                    {{-- Switch: Funcionário ativo - PARTE DESLIZANTE CENTRALIZADA --}}
