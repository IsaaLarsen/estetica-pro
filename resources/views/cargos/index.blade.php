...
<head>
    ...
    <title>Cargos - Estética PRO</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            {{-- Mensagem de sucesso (quando voltar do create/update/delete) --}}
            @if(session('success'))
    ...
    <script>
        ...
        // Busca na tabela (filtra linhas por texto)
        ...
        // Duplo clique: ir para funcionários do cargo
