...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            // ---------- FUNCIONÁRIOS x SERVIÇO via AJAX ----------
            ...
            // Quando mudar o serviço, recarregar funcionários
            ...
            // Preencher na carga inicial (edição ou quando volta com erro de validação)
